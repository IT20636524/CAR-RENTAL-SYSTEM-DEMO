...
// import DeleteStaff from '../components/modal/DeleteStaff'
    ...
    return (
        ...
        <div>
          ...
          <div>
            ...
            <h1 style={{"marginLeft":"700px","marginTop":"50px","marginBottom":"50px"}}>Driver Details</h1>
                <div className="bg-secondary text-center rounded p-4" >
                    ...
                    <div className="table-responsive">
                        ...
                        <thead className="thead-dark">
                            <tr>
                            <th scope="col" style={{"fontSize":"20px"}}>Code</th>
                                <th scope="col" style={{"fontSize":"20px"}}>Driver Name</th>
                                <th scope="col" style={{"fontSize":"20px"}}>Address</th>
                                <th scope="col" style={{"fontSize":"20px"}}>Contact </th>
                                <th scope="col" style={{"fontSize":"20px"}}>Gender</th>
                                <th scope="col" style={{"fontSize":"20px"}}>License No</th>
                                <th scope="col" style={{"fontSize":"20px"}}>Experience</th>
                                
                                <th className="text-center" scope="col" style={{"fontSize":"20px"}}>Action</th>
